<template>
    <div> <!-- template will not render without an outer container -->
        <div v-if="hoursImage" class="inside_page_banner margin_30" :style="{ backgroundImage: 'url(' + hoursImage.image_url + ')' }"></div>
